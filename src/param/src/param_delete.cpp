...
int main(int argc, char *argv[])
{
    ...
    // 2. 再次尝试删除 param_int 参数
    bool r2 = ros::param::del("param_int");
    ROS_INFO("第二次 ros::param::del(\"param_int\") 结果: %d", r2);

    bool exists_after2 = nh.hasParam("param_int");
    ROS_INFO("第二次删除后 param_int 是否存在: %d", exists_after2);
